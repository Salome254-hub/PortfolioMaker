...
const Sidebar = () => {
    return (
      ...
      <nav className="sidebar" data-simplebar>
        <div className="sidebar-header"><a href="#home" data-scroll><img className="img-fluid sidebar-avatar" src="img/flatlay.jpg" alt="Profile avatar"/></a><span className="sidebar-name">Username</span>
