...
const Profile = ({ updateState }) => {
  ...
  const [profile, setProfile] = useState({
    ...
    location: "",
    profile_url:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Circle-icons-profile.svg/512px-Circle-icons-profile.svg.png?20160314153816",
    title: "",
    description: "",
    phone_number: "",
    linkedin_link: "",
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-12 form-group">
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Brief description about your profession."
                  required="true"
                ></textarea>
              </div>
              <div class="col-12 col-md-6 form-group">
              ...
              <div class="col-12 form-submit">
                <button class="btn button-main button-scheme" type="submit">
                  Submit/Next step
                </button>
...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    fetch("/check_progress").then((data) => {
      if (data.ok) {
        data.json().then((data) => {
          ...
          <div class="outer_box">
            <div class="row">
              ...
              <div class="col-md-3 col-lg-10  col-sm-12 text-left">
                ...
                <div class="row">
                  <h6>
                    You have earned your free portfolio.Copy the link bellow and
                    share.
                  </h6>
                </div>
                <div class="row">
                  <div class="col-md-12 col-lg-8  col-sm-12 ">
                    <div class="input-group">
                      ...
                      <Link
                        className=" m-3 menu_ orange text-white"
                        to="/portfolio"
                      >
                        View Profile
                      </Link>
  ...
  return (
    <div class="main-wrapper">
      <Toaster />
      <nav className="navbar d-md-block d-lg-none fixed-top mobile-navbar">
        <button
          className="navbar-toggler mr-auto"
          type="button"
          data-toggle="collapse"
          data-target="#mobileNavbarSupportedContent"
          aria-controls="mobileNavbarSupportedContent"
          aria-expanded="false"
        ...
        <div
          className="collapse navbar-collapse order-1"
          id="mobileNavbarSupportedContent"
        >
      ...
      <nav className="sidebar" data-simplebar>
        <div className="sidebar-header">
          <a href="#home" data-scroll>
            <img
              ...
              className="img-fluid sidebar-avatar"
        ...
        <div className="sidebar-menu">
          <ul className="list-unstyled list-menu">
            <li>
              {" "}
              <Link className=" m-3 menu_" to="/portfolio">
                View Profile
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link className=" m-3 menu_" onClick={logOut} to="/portfolio">
                Modify Profile
              </Link>
            </li>
            <li>
              {" "}
              <Link className=" m-3 menu_" onClick={logOut}>
                Log out
              </Link>
            </li>

            <li>
              <a className="nav-link" href="#home-area" data-scroll></a>
            </li>
          </ul>
        </div>
      </nav>
      <div class="sections-wrapper">
        <section class="single-section contact-area alt-bg" id="contact-area">
          <div class="container text-left">
            <div class="row">
              <div class="col-12">
                <div class="section-heading">
                  ...
                  <h6 class=" red_text">
                    Thank you for, using Portfolio Maker.
                  </h6>
                </div>
              </div>
            </div>
            ...
            {servicesHide && (
              <Services updateState={updateState} user_id={userId} />
            )}

            {projectHide && (
              <Projects updateState={updateState} user_id={userId} />
            )}
