                        ...
                        <div class="row">
                            <div class="col-6">
                                <form class="contact-form " id="contact-form" action="http://likeabawz.dk/exill/demo/codex/template/php/contact.php">
                                    <div class="row">
                                        <div class="col-12 col-md-12 form-group"><input class="form-control" id="contact-name" type="text" name="name" placeholder=" Username" required="" /></div>

                                        <div class="col-12 col-md-12 form-group"><input class="form-control mb-3" id="contact-email" type="email" name="password" placeholder="Password" required="" />
